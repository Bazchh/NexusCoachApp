...
class MinimapReminderService : Service(), TextToSpeech.OnInitListener {
    companion object {
        const val ACTION_START = "com.nexuscoach.nexuscoach.START_MINIMAP"
        const val ACTION_STOP = "com.nexuscoach.nexuscoach.STOP_MINIMAP"
        const val EXTRA_INTERVAL_MS = "interval_ms"
        const val EXTRA_MESSAGE = "message"
        const val EXTRA_LOCALE = "locale"

        private const val CHANNEL_ID = "nexuscoach_minimap"
        private const val NOTIFICATION_ID = 2001
    }

    private val handler = Handler(Looper.getMainLooper())
    private var intervalMs = 45000L
    private var message = "Olhe o minimapa"
    ...
    private fun speak() {
        ...
        tts?.speak(message, TextToSpeech.QUEUE_FLUSH, null, "minimap")
    }
